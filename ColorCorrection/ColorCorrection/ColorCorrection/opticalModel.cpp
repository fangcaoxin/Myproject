	...
	for (int i = 0; i < height; i++) {
		for (int j = 0; j < width; j++) {
			...
			//cout << "trans " << t_b << " " << t_g << " " << t_r << endl;
				...
				dst.at<Vec3f>(i, j)[0] = (src.at<Vec3f>(i, j)[0] - air_light[0]) / max(t_b,(float)1) + air_light[0];
				dst.at<Vec3f>(i, j)[1] = (src.at<Vec3f>(i, j)[1] - air_light[1]) / max(t_g, (float)1) + air_light[1];
				dst.at<Vec3f>(i, j)[2] = (src.at<Vec3f>(i, j)[2] - air_light[2]) / max(t_r, (float)1) + air_light[2];
