...
%     s0= [s_init(1,i),s_init(1,i)];
    c0=[x,x,y*r/sqrt(x*x+y*y+z*z),y*R/sqrt(x*x+y*y+z*z)];
    fun = @slove_touch_point;
    c(i,:)= fsolve(fun,c0);
%     fun= @myfun;
%     c(i,:) = fsolve(fun,c0);
%     fun1 =@myfun1;
...
function q2 =  slove_touch_point(p2)
...
global n1 n2 n3 x y z R r d_c_a
x1 = p2(1);
x2 = p2(2);
y1 = p2(3);
y2 = p2(4);
q2(1) =(n2*(2*x1 - 2*x2))/(2*((x1 - x2)^2 + (y1 - y2)^2 + ((R^2 - y1^2)^(1/2) - (R^2 - y2^2)^(1/2))^2)^(1/2))...,
    + (n1*x1)/((d_c_a - (r^2 - y1^2)^(1/2))^2 + x1^2 + y1^2)^(1/2);
  
q2(2) = - (n2*(2*x1 - 2*x2))/(2*((x1 - x2)^2 + (y1 - y2)^2 + ((R^2 - y1^2)^(1/2) - (R^2 - y2^2)^(1/2))^2)^(1/2))...,
    - (n3*(2*x - 2*x2))/(2*((x - x2)^2 + (y - y2)^2 + (z - (R^2 - y2^2)^(1/2))^2)^(1/2));

q2(3)= (n1*(2*y1 + (2*y1*(d_c_a - (r^2 - y1^2)^(1/2)))/(r^2 - y1^2)^(1/2)))/(2*((d_c_a - (r^2 - y1^2)^(1/2))^2 + x1^2 + y1^2)^(1/2)) - ...,
    (n2*(2*y2 - 2*y1 + (2*y1*((R^2 - y1^2)^(1/2) - (R^2 - y2^2)^(1/2)))/(R^2 - y1^2)^(1/2)))/(2*((x1 - x2)^2 + (y1 - y2)^2 + ((R^2 - y1^2)^(1/2) - (R^2 - y2^2)^(1/2))^2)^(1/2));


q2(4) = (n3*(2*y2 - 2*y + (2*y2*(z - (R^2 - y2^2)^(1/2)))/(R^2 - y2^2)^(1/2)))/(2*((x - x2)^2 + (y - y2)^2 ...,
    + (z - (R^2 - y2^2)^(1/2))^2)^(1/2)) + (n2*(2*y2 - 2*y1 + (2*y2*((R^2 - y1^2)^(1/2) - (R^2 - y2^2)^(1/2)))/(R^2 - y2^2)^(1/2)))/(2*((x1 - x2)^2 + (y1 - y2)^2 + ((R^2 - y1^2)^(1/2) - (R^2 - y2^2)^(1/2))^2)^(1/2));
